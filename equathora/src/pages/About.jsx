                                    ...
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-6">
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col border-l-4 border-(--accent-color) md:border-none pl-4 md:pl-0">
                                                    <div className="flex items-center">
                                                        <div className="flex items-center md:h-14  rounded-md flex-shrink-0 pr-3">
                                                            <svg className="h-5 w-5" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
                                                                <defs>
                                                        ...
                                                        <h3 className="text-lg font-bold text-[var(--secondary-color)]">Clarity</h3>
                                                    </div>
